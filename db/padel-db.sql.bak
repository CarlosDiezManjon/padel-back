...
CREATE TABLE reservas (
  ...
  usuario_reservador_id INT NOT NULL,
  FOREIGN KEY (usuario_reservador_id) REFERENCES usuarios (id),
...
INSERT INTO usuarios (id, username, nombre, apellidos, email, telefono, password, saldo, tipo, fecha_alta, fecha_baja, activo, token_activacion, email_verificado) VALUES(1, 'admin', 'Admin', 'Admin Admin', 'cdiez1995@gmail.com', '645773320', '$2b$10$65DXZ7mQrblDL95fEeUyduRBOI2mHXF6j0OhNc3MdZe9kmIoMPUTS', 0.00, 0, '2024-01-14 19:46:57.398', NULL, true, 'GY2vvXy6Hc8DwtvY', true);
